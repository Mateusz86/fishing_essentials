...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        FishesDao.createTable(db, ifNotExists);
        PlacesDao.createTable(db, ifNotExists);
        FishingDao.createTable(db, ifNotExists);
        CaughtFishDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        FishesDao.dropTable(db, ifExists);
        PlacesDao.dropTable(db, ifExists);
        FishingDao.dropTable(db, ifExists);
        CaughtFishDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(FishesDao.class);
        registerDaoClass(PlacesDao.class);
        registerDaoClass(FishingDao.class);
