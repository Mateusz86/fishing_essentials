...
*/
public class MethodsDao extends AbstractDao<Methods, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Methods entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Methods entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Methods entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
